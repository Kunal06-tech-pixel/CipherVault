...
const item = (id: string, type: VaultItem['type'], updatedAt: string, archived = false): VaultItem => ({ id, type, name: id, fields: {}, favorite: false, tags: [], archived, createdAt: updatedAt, updatedAt })
...
describe('vault dashboard metrics', () => {
  ...
  it('counts live categories and archive separately', () => { expect(categoryCounts([item('a', 'login', '2026-01-01T00:00:00Z'), item('b', 'card', '2026-01-01T00:00:00Z', true)])).toMatchObject({ login: 1, card: 0, archive: 1 }) })
