  ...
  return <main className="landing-page">
    <nav className="landing-nav" aria-label="Public">
      ...
      <div>
        ...
        <a className="landing-nav-action" href="/app">{brand.copy.launchCta}<ArrowRight size={15} /></a>
      </div>
    </nav>
    ...
    <section id="product" className="landing-hero">
      ...
      <div className="landing-hero-content">
        ...
        <h1>Keys stay on your device. <span>Servers never see your secrets.</span></h1>
        ...
        <div className="landing-pills" aria-label="Security guarantees">
          <span><FileKey2 size={14} /> Client-side encryption</span>
          <span><ServerCog size={14} /> Zero-knowledge sync</span>
    ...
    <section id="security" className="landing-section landing-trust">
      <div className="landing-section-head">
        <div>
          ...
          <h2>Built around a simple truth: <span>only you</span> can read your data.</h2>
        </div>
        <p>{brand.productName} is designed so the server cannot access your keys - by architecture, not by promise.</p>
      </div>
      <div className="landing-trust-grid">
        {trustPoints.map(({ icon: Icon, visual, title, copy }) => <article key={title}>
          <Icon size={21} />
          <div className={`landing-card-art ${visual}`} aria-hidden="true"><i /><i /><i /></div>
          <h3>{title}</h3>
          <p>{copy}</p>
        </article>)}
      </div>
    ...
    <section className="landing-section landing-model">
      <div>
        ...
        <h2>Secrets are decrypted only <span>inside the app session.</span></h2>
      </div>
      <ul>
    ...
    <section id="beta" className="landing-section landing-beta">
      <div className="landing-beta-status">
        <div>
          ...
          <h2>Private beta. Not public. <span>By design.</span></h2>
    ...
    <section id="enterprise" className="landing-final">
      ...
      <div>
        <a className="primary-button" href="/app">Launch {brand.productName}<ArrowRight size={16} /></a>
        <a className="secondary-button landing-secondary" href="/app?mode=register">{brand.copy.createAccountCta}</a>
      </div>
    </section>
    ...
    <footer className="landing-footer">
      ...
      <nav aria-label="Footer">
        ...
        <a id="pricing" href="#beta">Pricing</a>
      </nav>
