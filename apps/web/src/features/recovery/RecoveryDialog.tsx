...
export function RecoveryDialog({ recoveryKey, onDone }: { recoveryKey: string; onDone: () => void }) {
  ...
  return <div className="modal-backdrop"><section className="modal recovery-modal" role="dialog" aria-modal="true">
    <div className="recovery-shield"><ShieldCheck size={28} /></div>
    <p className="eyebrow">One-time recovery kit</p><h2>Save this key offline</h2>
