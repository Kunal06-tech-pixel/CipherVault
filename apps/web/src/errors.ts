...
export function readableError(error: unknown): string {
  if (error instanceof ApiError) {
    return ({
      ...
      origin_rejected: `This request did not come from the configured ${brand.productName} application.`,
      ...
      service_unavailable: import.meta.env.DEV
        ...
        : `${brand.productName} is temporarily unavailable. Please try again shortly.`,
